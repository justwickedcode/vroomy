...
- To spin up a db, you can use the `docker-compose` file I gave you. Just run `docker-compose up -d`. To turn it off, `docker-compose down -v`. (-v = delete volume / delete the data you stored in the db already) ✔️
