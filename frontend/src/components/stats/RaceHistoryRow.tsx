...
export default function RaceHistoryRow({ race }: { race: RaceRecord }) {
  return (
    <div className="grid grid-cols-[1fr_auto_auto_auto] items-center gap-3 rounded-md px-2 py-2 text-sm hover:bg-accent/30">
